Primary_mystic_flare =  Primary_mystic_flare or class({})
LinkLuaModifier( "modifier_Primary_mystic_flare_thinker", "skills/Primary_mystic_flare", LUA_MODIFIER_MOTION_NONE )




function Primary_mystic_flare:Precache( context )
...
function Primary_mystic_flare:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end

function Primary_mystic_flare:OnSpellStart()
	-- unit identifier
	...
	CreateModifierThinker(
		...
		self, -- ability source
		"modifier_Primary_mystic_flare_thinker", -- modifier name
...
modifier_Primary_mystic_flare_thinker = modifier_Primary_mystic_flare_thinker or class({})

--------------------------------------------------------------------------------
-- Initializations
function modifier_Primary_mystic_flare_thinker:OnCreated( keys )
	-- references
...
function modifier_Primary_mystic_flare_thinker:OnDestroy()
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_Primary_mystic_flare_thinker:OnIntervalThink()
...
function modifier_Primary_mystic_flare_thinker:PlayEffects( radius, duration, interval )
...
function modifier_Primary_mystic_flare_thinker:PlayEffectsHit( pos )
