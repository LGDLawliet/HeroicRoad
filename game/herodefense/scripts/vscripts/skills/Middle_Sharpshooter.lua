Middle_Sharpshooter = class({})
LinkLuaModifier("modifier_generic_arc_lua", "modifier/generic/modifier_generic_arc_lua", LUA_MODIFIER_MOTION_BOTH)
LinkLuaModifier("modifier_Middle_Sharpshooter", "skills/Middle_Sharpshooter", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_Middle_Sharpshooter_debuff", "skills/Middle_Sharpshooter", LUA_MODIFIER_MOTION_NONE)





function Middle_Sharpshooter:Precache( context )
...
function Middle_Sharpshooter:Spawn()
	if not IsServer() then return end
end


function Middle_Sharpshooter:OnSpellStart()
	...
	caster:AddNewModifier(
		...
		self, -- ability source
		"modifier_Middle_Sharpshooter", -- modifier name
		{
			duration = duration,
			x = point.x,
			y = point.y,
...
function Middle_Sharpshooter:OnProjectileThink_ExtraData( location, ExtraData )
	local sound = EntIndexToHScript( ExtraData.sound )
	if not sound or sound:IsNull() then return end
	sound:SetOrigin( location )
end

function Middle_Sharpshooter:OnProjectileHit_ExtraData( target, location, ExtraData )
	...
	local bonus_damage_index_all = math.max(ExtraData.bonus_damage,0)
	...
	target:AddNewModifier(
		caster, -- player source
		self, -- ability source
		"modifier_Middle_Sharpshooter_debuff", -- modifier name
		{
...
function Middle_Sharpshooter:PlayEffects( target, direction )
	-- Get Resources
...
modifier_Middle_Sharpshooter = class({})

function modifier_Middle_Sharpshooter:IsHidden()	return false end
function modifier_Middle_Sharpshooter:IsDebuff()	return false end
function modifier_Middle_Sharpshooter:IsPurgable()	return false end
function modifier_Middle_Sharpshooter:OnCreated( kv )
	-- references
...
function modifier_Middle_Sharpshooter:OnDestroy()
	if not IsServer() then return end
...
-- Modifier Effects
function modifier_Middle_Sharpshooter:DeclareFunctions()
	local funcs = {
...
function modifier_Middle_Sharpshooter:GetOverrideAnimation(params)
...
function modifier_Middle_Sharpshooter:OnOrder( params )
...
function modifier_Middle_Sharpshooter:GetModifierMoveSpeed_Limit()
	return 0.1
end

function modifier_Middle_Sharpshooter:GetModifierTurnRate_Percentage()
	return -self.turn_rate
end

function modifier_Middle_Sharpshooter:GetModifierDisableTurning()
	return 1
end

-- Status Effects
function modifier_Middle_Sharpshooter:CheckState()
	local state = {
...
-- Interval Effects
function modifier_Middle_Sharpshooter:OnIntervalThink()
...
-- Helper
function modifier_Middle_Sharpshooter:SetDirection( vec )
	self.target_dir = ((vec-self.parent:GetOrigin())*Vector(1,1,0)):Normalized()
	self.face_target = false
end

function modifier_Middle_Sharpshooter:TurnLogic()
...
function modifier_Middle_Sharpshooter:UpdateStack()
...
-- Filter
function modifier_Middle_Sharpshooter:OrderFilter( data )
...
-- Graphics & Animations
function modifier_Middle_Sharpshooter:PlayEffects1()
	-- Get Resources
...
function modifier_Middle_Sharpshooter:PlayEffects2()
...
function modifier_Middle_Sharpshooter:PlayEffects3( seconds, half )
...
function modifier_Middle_Sharpshooter:PlayEffects4( modifier )
...
function modifier_Middle_Sharpshooter:UpdateEffect()
	local startpos = self.parent:GetAbsOrigin()
...
modifier_Middle_Sharpshooter_debuff = class({})

function modifier_Middle_Sharpshooter_debuff:IsHidden()	return false end
function modifier_Middle_Sharpshooter_debuff:IsDebuff()	return true end
function modifier_Middle_Sharpshooter_debuff:IsStunDebuff()	return false end
function modifier_Middle_Sharpshooter_debuff:IsPurgable()	return true end
function modifier_Middle_Sharpshooter_debuff:OnCreated( kv )
	-- references
	self.parent = self:GetParent()
...
function modifier_Middle_Sharpshooter_debuff:DeclareFunctions()
	local funcs = {
...
function modifier_Middle_Sharpshooter_debuff:GetModifierMoveSpeedBonus_Constant()
	return self.slow
end

function modifier_Middle_Sharpshooter_debuff:CheckState()
	local state = {
...
function modifier_Middle_Sharpshooter_debuff:PlayEffects( direction )
