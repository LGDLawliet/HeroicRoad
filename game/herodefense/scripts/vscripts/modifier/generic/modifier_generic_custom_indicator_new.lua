...
--------------------------------------------------------------------------------
modifier_generic_custom_indicator_new = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_generic_custom_indicator_new:IsHidden()
	return true
end

function modifier_generic_custom_indicator_new:IsPurgable()
	return true
end

function modifier_generic_custom_indicator_new:GetAttributes()
	return MODIFIER_ATTRIBUTE_PERMANENT + MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_generic_custom_indicator_new:OnCreated( kv )
...
function modifier_generic_custom_indicator_new:OnRefresh( kv )
end

function modifier_generic_custom_indicator_new:OnRemoved()
end

function modifier_generic_custom_indicator_new:OnDestroy()
end
...
function modifier_generic_custom_indicator_new:OnIntervalThink()
	if IsClient() then
		-- end
...
function modifier_generic_custom_indicator_new:Register( loc )
