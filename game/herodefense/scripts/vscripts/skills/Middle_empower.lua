Middle_empower = class({})
LinkLuaModifier( "modifier_Middle_empower", "skills/Middle_empower", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Init Abilities
function Middle_empower:Precache( context )
...
function Middle_empower:OnSpellStart()
	-- unit identifier
	...
	target:AddNewModifier(caster, self, "modifier_Middle_empower", { duration = duration*ModifierStatusGain } )
...
modifier_Middle_empower = class({})

function modifier_Middle_empower:IsHidden()	return false end
function modifier_Middle_empower:IsDebuff()	return false end
function modifier_Middle_empower:IsPurgable()	return true end


function modifier_Middle_empower:OnCreated( kv )
...
function modifier_Middle_empower:OnRefresh( kv )
	self:OnCreated( kv )
end


function modifier_Middle_empower:DeclareFunctions()
	local funcs = {
...
function modifier_Middle_empower:OnTooltip()
	return self.cleave
end
function modifier_Middle_empower:GetModifierProcAttack_Feedback( keys )
	if not IsServer() then return end
...
function modifier_Middle_empower:GetModifierBaseDamageOutgoing_Percentage()	return self.damage end
function modifier_Middle_empower:GetEffectName()	return "particles/units/heroes/hero_magnataur/magnataur_empower.vpcf" end
function modifier_Middle_empower:GetEffectAttachType()	return PATTACH_ABSORIGIN_FOLLOW end



function modifier_Middle_empower:GetModifierPreAttack_BonusDamage(keys)
