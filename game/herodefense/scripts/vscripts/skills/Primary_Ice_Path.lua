...
Primary_Ice_Path = class({})
LinkLuaModifier("modifier_Primary_Ice_Path_debuff", "skills/Primary_Ice_Path", LUA_MODIFIER_MOTION_NONE)



function Primary_Ice_Path:IsHiddenWhenStolen() 		return false end
function Primary_Ice_Path:IsRefreshable() 			return true end
function Primary_Ice_Path:IsStealable() 			return true end
function Primary_Ice_Path:IsNetherWardStealable() 	return true end
--add by MB 0823
--------------------------------------------------------------------
function Primary_Ice_Path:OnSpellStart()
...
--------------------------------------------------------------------
function Primary_Ice_Path:Spell_SplitIcePath(vSource,vCount)
...
--------------------------------------------------------------------
function Primary_Ice_Path:OnProjectileHit_ExtraData(target, location, kv)
	...
	if not target:IsMagicImmune() then
		target:AddNewModifier(  self:GetCaster(), self, "modifier_Primary_Ice_Path_debuff", {duration = duration} )
...
modifier_Primary_Ice_Path_debuff = class({})

function modifier_Primary_Ice_Path_debuff:IsDebuff()	return true end
function modifier_Primary_Ice_Path_debuff:IsHidden()	return false end
function modifier_Primary_Ice_Path_debuff:IsPurgable()	return false end
function modifier_Primary_Ice_Path_debuff:IsPurgeException()	return true end
function modifier_Primary_Ice_Path_debuff:IsStunDebuff() return true end
function modifier_Primary_Ice_Path_debuff:GetStatusEffectName()	return "particles/status_fx/status_effect_frost_lich.vpcf"	end
function modifier_Primary_Ice_Path_debuff:StatusEffectPriority() return 100	end
function modifier_Primary_Ice_Path_debuff:GetEffectName()	return "particles/generic_gameplay/generic_frozen.vpcf"	end
function modifier_Primary_Ice_Path_debuff:GetEffectAttachType()	return PATTACH_ABSORIGIN_FOLLOW	end
function modifier_Primary_Ice_Path_debuff:CheckState()	
	return	{
