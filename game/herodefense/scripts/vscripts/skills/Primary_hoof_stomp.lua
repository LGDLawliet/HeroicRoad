Primary_hoof_stomp = class({})


function Primary_hoof_stomp:GetCastRange()
	return self:GetSpecialValueFor("radius")
end

function Primary_hoof_stomp:OnSpellStart()
...
function Primary_hoof_stomp:PlayEffects()
...
function Primary_hoof_stomp:GetDouble_edge()
