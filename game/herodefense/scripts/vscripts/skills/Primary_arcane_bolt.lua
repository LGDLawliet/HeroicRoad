Primary_arcane_bolt = Primary_arcane_bolt or class({})

function Primary_arcane_bolt:Precache( context )
...
function Primary_arcane_bolt:OnSpellStart()
	-- unit identifier
...
--------------------------------------------------------------------------------
-- Projectile
function Primary_arcane_bolt:OnProjectileHit_ExtraData( target, location, extraData )
