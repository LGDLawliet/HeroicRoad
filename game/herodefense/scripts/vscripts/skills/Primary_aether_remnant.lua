Primary_aether_remnant = class({})
LinkLuaModifier( "modifier_Primary_aether_remnant", "skills/Primary_aether_remnant", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_Primary_aether_remnant_thinker", "skills/Primary_aether_remnant", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Ability Phase Start
function Primary_aether_remnant:OnAbilityPhaseInterrupted()

end
function Primary_aether_remnant:OnAbilityPhaseStart()
...
--------------------------------------------------------------------------------
-- Ability Start
function Primary_aether_remnant:OnSpellStart()
	-- unit identifier
	local caster = self:GetCaster()
	local targets = self:GetVectorTargetPosition()

	-- create thinker
	CreateModifierThinker(caster, self, "modifier_Primary_aether_remnant_thinker", 
		{
...
modifier_Primary_aether_remnant = class({})
function modifier_Primary_aether_remnant:IsHidden()	return false end
function modifier_Primary_aether_remnant:IsDebuff()	return true end
function modifier_Primary_aether_remnant:IsStunDebuff()	return true end
function modifier_Primary_aether_remnant:IsPurgable()	return true end
function modifier_Primary_aether_remnant:OnCreated( kv )
...
function modifier_Primary_aether_remnant:OnRefresh( kv )
	self:OnCreated( kv )
end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_Primary_aether_remnant:DeclareFunctions()
	local funcs = {
...
function modifier_Primary_aether_remnant:GetModifierMoveSpeed_Absolute()
	if IsServer() then return self.speed end
end

function modifier_Primary_aether_remnant:CheckState()
	local state = {
...
function modifier_Primary_aether_remnant:GetStatusEffectName()	return "particles/status_fx/status_effect_void_spirit_aether_remnant.vpcf" end
function modifier_Primary_aether_remnant:StatusEffectPriority()	return MODIFIER_PRIORITY_NORMAL end



modifier_Primary_aether_remnant_thinker = class({})
local STATE_RUN = 1
local STATE_DELAY = 2
local STATE_WATCH = 3
local STATE_PULL = 4

function modifier_Primary_aether_remnant_thinker:OnCreated( kv )
...
function modifier_Primary_aether_remnant_thinker:OnRefresh( kv )
	if not IsServer() then return end
	self.state = kv.state
end

function modifier_Primary_aether_remnant_thinker:OnRemoved()
end

function modifier_Primary_aether_remnant_thinker:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_Primary_aether_remnant_thinker:OnIntervalThink()
...
function modifier_Primary_aether_remnant_thinker:WatchLogic()
	-- provides vision
	...
	for _, unit in ipairs(enemies) do
		if not unit:FindModifierByName("modifier_Primary_aether_remnant") then
			enemy = unit
		end
	end
	if not enemy then
	...
	enemy:AddNewModifier(
		...
		"modifier_Primary_aether_remnant", -- modifier name
		{
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Primary_aether_remnant_thinker:PlayEffects1()
	-- Get Resources
...
function modifier_Primary_aether_remnant_thinker:PlayEffects2()
	-- Get Resources
...
function modifier_Primary_aether_remnant_thinker:PlayEffects3()
	-- Get Resources
...
function modifier_Primary_aether_remnant_thinker:PlayEffects4( target )
	-- Get Resources
...
function modifier_Primary_aether_remnant_thinker:PlayEffects5()
	-- Get Resources
