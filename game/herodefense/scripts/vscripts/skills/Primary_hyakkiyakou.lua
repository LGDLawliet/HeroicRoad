...
Primary_hyakkiyakou = class({})

LinkLuaModifier("modifier_Primary_hyakkiyakou_thinker", "skills/Primary_hyakkiyakou", LUA_MODIFIER_MOTION_NONE)

function Primary_hyakkiyakou:IsHiddenWhenStolen() 	return false end
function Primary_hyakkiyakou:IsRefreshable() 		return true end
function Primary_hyakkiyakou:IsStealable() 			return true end
-- function Primary_hyakkiyakou:GetIntrinsicModifierName() return "modifier_Primary_hyakkiyakou_mod" end
function Primary_hyakkiyakou:GetAOERadius()
	return self:GetSpecialValueFor("radius")
end
function Primary_hyakkiyakou:OnSpellStart()
	...
	local thinker =CreateModifierThinker(
		self:GetCaster(),
		self,
		"modifier_Primary_hyakkiyakou_thinker",
		{
...
function Primary_hyakkiyakou:OnProjectileHit_ExtraData(target, location, keys)
...
modifier_Primary_hyakkiyakou_thinker = class({})

function modifier_Primary_hyakkiyakou_thinker:OnCreated(params)
	if IsServer() then
...
function modifier_Primary_hyakkiyakou_thinker:OnIntervalThink()
...
function modifier_Primary_hyakkiyakou_thinker:OnDestroy(params)
	if not IsServer() then
		return
	end
