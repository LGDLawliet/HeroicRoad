Primary_astral_step = class({})

LinkLuaModifier( "modifier_Primary_astral_step", "skills/Primary_astral_step", LUA_MODIFIER_MOTION_NONE )



function Primary_astral_step:OnSpellStart()
	...
	for _,enemy in pairs(enemies) do
		...
		enemy:AddNewModifier(caster, self,"modifier_Primary_astral_step", { duration = delay })
...
--------------------------------------------------------------------------------
function Primary_astral_step:PlayEffects1( origin, target )
...
function Primary_astral_step:PlayEffects2( target )
...
modifier_Primary_astral_step = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Primary_astral_step:IsHidden()	return false end
function modifier_Primary_astral_step:IsDebuff()	return true end
function modifier_Primary_astral_step:IsStunDebuff()	return false end
function modifier_Primary_astral_step:IsPurgable()	return true end
function modifier_Primary_astral_step:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end

--------------------------------------------------------------------------------
-- Initializations
function modifier_Primary_astral_step:OnCreated( kv )
	-- references
...
function modifier_Primary_astral_step:OnDestroy()
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_Primary_astral_step:DeclareFunctions()
	local funcs = {
...
function modifier_Primary_astral_step:GetModifierMoveSpeedBonus_Constant()	return self.slow end

function modifier_Primary_astral_step:GetEffectName()
	return "particles/units/heroes/hero_void_spirit/astral_step/void_spirit_astral_step_debuff.vpcf"
end

function modifier_Primary_astral_step:GetEffectAttachType()	return PATTACH_ABSORIGIN_FOLLOW end
function modifier_Primary_astral_step:GetStatusEffectName()
	return "particles/status_fx/status_effect_void_spirit_astral_step_debuff.vpcf"
end

function modifier_Primary_astral_step:StatusEffectPriority()	return MODIFIER_PRIORITY_NORMAL end

function modifier_Primary_astral_step:PlayEffects()
