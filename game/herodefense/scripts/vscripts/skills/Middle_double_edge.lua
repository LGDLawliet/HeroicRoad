Middle_double_edge = class({})


function Middle_double_edge:Precache( context )
	PrecacheResource( "particle", "particles/units/heroes/hero_centaur/centaur_double_edge.vpcf", context )
end

function Middle_double_edge:OnSpellStart(talent3Target)
	-- unit identifier
...
--------------------------------------------------------------------------------
function Middle_double_edge:PlayEffects( target )
	-- Get Resources
