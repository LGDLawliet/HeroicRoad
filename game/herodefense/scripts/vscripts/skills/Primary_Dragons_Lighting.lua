...
LinkLuaModifier("modifier_Primary_Dragons_Lighting", "skills/Primary_Dragons_Lighting", LUA_MODIFIER_MOTION_NONE)

Primary_Dragons_Lighting			= Primary_Dragons_Lighting or class({})


-- function Primary_Dragons_Lighting:GetCastRange(location, target)
-- 	return self.BaseClass.GetCastRange(self, location, target)
-- end
require('internal/timers')   --计时器功能
function Primary_Dragons_Lighting:OnSpellStart()
	...
	if not target:TriggerSpellAbsorb(self) then
		...
		-- self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_Primary_Dragons_Lighting", {
...
-- modifier_Primary_Dragons_Lighting= modifier_Primary_Dragons_Lighting or class({})

-- function modifier_Primary_Dragons_Lighting:IsHidden()		return true end
-- function modifier_Primary_Dragons_Lighting:IsPurgable()		return false end
-- function modifier_Primary_Dragons_Lighting:RemoveOnDeath()	return false end
-- function modifier_Primary_Dragons_Lighting:GetAttributes()	return MODIFIER_ATTRIBUTE_MULTIPLE end

-- function modifier_Primary_Dragons_Lighting:OnCreated(keys)
