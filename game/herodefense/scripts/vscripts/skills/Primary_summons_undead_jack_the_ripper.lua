...
LinkLuaModifier( "modifier_Primary_summons_undead_jack_the_ripper_buff", "skills/Primary_summons_undead_jack_the_ripper", LUA_MODIFIER_MOTION_NONE )
Primary_summons_undead_jack_the_ripper						= Primary_summons_undead_jack_the_ripper or class({})
-- require("internal/timers")
function Primary_summons_undead_jack_the_ripper:IsSummonSpell()return true end

function Primary_summons_undead_jack_the_ripper:OnSpellStart()
	...
	unit:AddNewModifier(caster, self, "modifier_Primary_summons_undead_jack_the_ripper_buff", {})
	...
	-- caster:AddNewModifier(caster, self, "modifier_Primary_summons_undead_jack_the_ripper_debuff", 
...
modifier_Primary_summons_undead_jack_the_ripper_buff = class({})

function modifier_Primary_summons_undead_jack_the_ripper_buff:IsDebuff() return false end
function modifier_Primary_summons_undead_jack_the_ripper_buff:IsHidden() return true end
function modifier_Primary_summons_undead_jack_the_ripper_buff:IsPurgable() 		return false end
function modifier_Primary_summons_undead_jack_the_ripper_buff:IsPurgeException() 	return false end
function modifier_Primary_summons_undead_jack_the_ripper_buff:RemoveOnDeath()  return false end

function modifier_Primary_summons_undead_jack_the_ripper_buff:DeclareFunctions()
	return {
...
function modifier_Primary_summons_undead_jack_the_ripper_buff:OnTakeDamage( params )
