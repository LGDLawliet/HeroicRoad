...
Primary_Shadow_Wave = class({})


function Primary_Shadow_Wave:IsHiddenWhenStolen() 		return false end
function Primary_Shadow_Wave:IsRefreshable() 			return true  end
function Primary_Shadow_Wave:IsStealable() 				return true  end
function Primary_Shadow_Wave:IsNetherWardStealable()	return true end

function Primary_Shadow_Wave:OnSpellStart()
	...
	for k, unit in pairs(units) do
		...
		local health = (self:GetSpecialValueFor("basic_damage")+self:GetSpecialValueFor("bonus_damage")*caster:GetIntellect(false))
