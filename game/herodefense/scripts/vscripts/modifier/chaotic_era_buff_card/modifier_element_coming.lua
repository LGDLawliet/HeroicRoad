...
modifier_element_coming = advanced_modifier({})

function modifier_element_coming:IsHidden()return false end
function modifier_element_coming:IsDebuff()return false end
function modifier_element_coming:IsPurgable()return false end
function modifier_element_coming:IsPurgeException() 	return false end
function modifier_element_coming:RemoveOnDeath() return true end
function modifier_element_coming:GetAttributes() return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE end
function modifier_element_coming:GetTexture() return self.texture end

function modifier_element_coming:OnCreated(keys)
    if IsServer() then
        -- print("okkkkkkkkkkkk")
...
function modifier_element_coming:ModifyTaskData(data)
    -- print("处理符石")
