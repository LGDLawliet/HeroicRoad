creeps_spell_dragon_slave = class({})


function creeps_spell_dragon_slave:GetCastRange()
	-- local caster =self:GetCaster()
	return self:GetSpecialValueFor("range")

end
-- function creeps_spell_dragon_slave:RequiresFacing() return false end

function creeps_spell_dragon_slave:OnSpellStart()
	-- unit identifier
	local caster = self:GetCaster()
...
--------------------------------------------------------------------------------
-- Projectile
function creeps_spell_dragon_slave:OnProjectileHitHandle( target, location, projectile )
	...
	local damageTable = {
		...
		damage = self:GetSpecialValueFor("damage")+self:GetSpecialValueFor("bonus_damage")*self:GetCaster():GetDamageMax(),
...
--------------------------------------------------------------------------------
function creeps_spell_dragon_slave:PlayEffects( target, direction )
	-- Get Resources
