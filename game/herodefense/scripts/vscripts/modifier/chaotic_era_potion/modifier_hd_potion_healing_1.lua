...
modifier_hd_potion_healing_1 = advanced_modifier({})

function modifier_hd_potion_healing_1:IsHidden()return true end
function modifier_hd_potion_healing_1:IsDebuff()return false end
function modifier_hd_potion_healing_1:IsPurgable()return false end
function modifier_hd_potion_healing_1:IsPurgeException() 	return false end
function modifier_hd_potion_healing_1:RemoveOnDeath() return false end
function modifier_hd_potion_healing_1:GetAttributes() return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE+ MODIFIER_ATTRIBUTE_MULTIPLE end
-- function modifier_hd_potion_healing_1:GetTexture() return "modifier_illusion" end
function modifier_hd_potion_healing_1:Precache( context )
	PrecacheResource( "particle", "particles/rebuild/potion/hd_potion_healing/effect_use/effect.vpcf", context )

end
function modifier_hd_potion_healing_1:OnCreated(keys)
...
function modifier_hd_potion_healing_1:PlayEffect(parent)
