Primary_astral_imprisonment =Primary_astral_imprisonment or class({})
LinkLuaModifier( "modifier_Primary_astral_imprisonment", "skills/Primary_astral_imprisonment", LUA_MODIFIER_MOTION_NONE )

function Primary_astral_imprisonment:GetAOERadius() return self:GetSpecialValueFor("radius") end



function Primary_astral_imprisonment:OnSpellStart()
	-- unit identifier
	...
	target:AddNewModifier(
		...
		self, -- ability source
		"modifier_Primary_astral_imprisonment", -- modifier name
...
modifier_Primary_astral_imprisonment = modifier_Primary_astral_imprisonment or class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Primary_astral_imprisonment:IsHidden()	return false end
function modifier_Primary_astral_imprisonment:IsDebuff()
	return self:GetCaster():GetTeamNumber()~=self:GetParent():GetTeamNumber()
end

function modifier_Primary_astral_imprisonment:IsStunDebuff()	return true end
function modifier_Primary_astral_imprisonment:IsPurgable()	return true end
function modifier_Primary_astral_imprisonment:RemoveOnDeath()	return false end

--------------------------------------------------------------------------------
-- Initializations
function modifier_Primary_astral_imprisonment:OnCreated( kv )
	-- references
...
function modifier_Primary_astral_imprisonment:OnRefresh( kv )
	-- references
	local damage = self:GetAbility():GetSpecialValueFor( "bonus_damage" )*self:GetCaster():GetIntellect(false)
	self.radius = self:GetAbility():GetSpecialValueFor( "radius" )
...
function modifier_Primary_astral_imprisonment:OnDestroy()
	if not IsServer() then return end
	-- find enemies
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_Primary_astral_imprisonment:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Primary_astral_imprisonment:PlayEffects()
	-- Get Resources
