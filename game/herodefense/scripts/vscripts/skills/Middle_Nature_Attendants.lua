Middle_Nature_Attendants = class({})
LinkLuaModifier("modifier_Middle_Nature_Attendants_hp", "skills/Middle_Nature_Attendants", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_Middle_Nature_Attendants_Purge", "skills/Middle_Nature_Attendants", LUA_MODIFIER_MOTION_NONE)

function Middle_Nature_Attendants:IsHiddenWhenStolen()        return false end
function Middle_Nature_Attendants:IsStealable()               return true end
function Middle_Nature_Attendants:IsRefreshable() 			return true end

function Middle_Nature_Attendants:OnSpellStart()
    ...
    caster:AddNewModifier(caster, self, "modifier_Middle_Nature_Attendants_hp", {duration = self:GetSpecialValueFor("duration")*ModifierStatusGain})
    caster:AddNewModifier(caster, self, "modifier_Middle_Nature_Attendants_Purge", {duration = self:GetSpecialValueFor("duration")*ModifierStatusGain})
end



modifier_Middle_Nature_Attendants_hp = class({})

function modifier_Middle_Nature_Attendants_hp:IsPurgable() 			return false end
function modifier_Middle_Nature_Attendants_hp:IsPurgeException()   	return true end
function modifier_Middle_Nature_Attendants_hp:IsHidden()				return false end
function modifier_Middle_Nature_Attendants_hp:GetAttributes()				return MODIFIER_ATTRIBUTE_MULTIPLE end

function modifier_Middle_Nature_Attendants_hp:OnCreated()		
...
function modifier_Middle_Nature_Attendants_hp:OnRefresh()		
   self:OnCreated()	
end

function modifier_Middle_Nature_Attendants_hp:OnIntervalThink()	
...
modifier_Middle_Nature_Attendants_Purge = class({})

function modifier_Middle_Nature_Attendants_Purge:IsPurgable() 			return false end
function modifier_Middle_Nature_Attendants_Purge:IsPurgeException()   	return true end
function modifier_Middle_Nature_Attendants_Purge:IsHidden()				return true end
function modifier_Middle_Nature_Attendants_Purge:GetAttributes()				return MODIFIER_ATTRIBUTE_MULTIPLE end

function modifier_Middle_Nature_Attendants_Purge:OnCreated()		
    if IsServer() then
        local ability = self:GetAbility()
...
function modifier_Middle_Nature_Attendants_Purge:OnRefresh()		
   self:OnCreated()	
end

function modifier_Middle_Nature_Attendants_Purge:OnIntervalThink()			
