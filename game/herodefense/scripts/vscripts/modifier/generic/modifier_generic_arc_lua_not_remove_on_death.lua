...
--------------------------------------------------------------------------------
modifier_generic_arc_lua_not_remove_on_death = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_generic_arc_lua_not_remove_on_death:IsHidden()
	return true
end

function modifier_generic_arc_lua_not_remove_on_death:IsDebuff()
	return false
end

function modifier_generic_arc_lua_not_remove_on_death:IsStunDebuff()
	return false
end

function modifier_generic_arc_lua_not_remove_on_death:IsPurgable()
	return true
end
function modifier_generic_arc_lua_not_remove_on_death:RemoveOnDeath() return false end
function modifier_generic_arc_lua_not_remove_on_death:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_generic_arc_lua_not_remove_on_death:OnCreated( kv )
...
function modifier_generic_arc_lua_not_remove_on_death:OnRefresh( kv )
	self:OnCreated( kv )
end

function modifier_generic_arc_lua_not_remove_on_death:OnRemoved()
end

function modifier_generic_arc_lua_not_remove_on_death:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_generic_arc_lua_not_remove_on_death:DeclareFunctions()
	local funcs = {
...
function modifier_generic_arc_lua_not_remove_on_death:GetModifierDisableTurning()
	if not self.isForward then return end
	return 1
end
function modifier_generic_arc_lua_not_remove_on_death:GetOverrideAnimation()
	return self:GetStackCount()
end
--------------------------------------------------------------------------------
-- Status Effects
function modifier_generic_arc_lua_not_remove_on_death:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion Effects
function modifier_generic_arc_lua_not_remove_on_death:UpdateHorizontalMotion( me, dt )
...
function modifier_generic_arc_lua_not_remove_on_death:UpdateVerticalMotion( me, dt )
	if self.fix_duration and self:GetElapsedTime()>=self.duration then return end
...
function modifier_generic_arc_lua_not_remove_on_death:OnHorizontalMotionInterrupted()
	self.interrupted = true
	self:SafeDestroy()
end

function modifier_generic_arc_lua_not_remove_on_death:OnVerticalMotionInterrupted()
	self.interrupted = true
	self:SafeDestroy()
end
...
--------------------------------------------------------------------------------
-- Motion Helper
function modifier_generic_arc_lua_not_remove_on_death:SetJumpParameters( kv )
...
function modifier_generic_arc_lua_not_remove_on_death:Jump()
...
function modifier_generic_arc_lua_not_remove_on_death:InitVerticalArc( height_start, height_max, height_end, duration )
...
function modifier_generic_arc_lua_not_remove_on_death:GetVerticalPos( time )
	return self.const1*time - self.const2*time*time
end

function modifier_generic_arc_lua_not_remove_on_death:GetVerticalSpeed( time )
	return self.const1 - 2*self.const2*time
end

--------------------------------------------------------------------------------
-- Helper
function modifier_generic_arc_lua_not_remove_on_death:SetEndCallback( func )
