...
modifier_hd_potion_regen_mana_1 = advanced_modifier({})

function modifier_hd_potion_regen_mana_1:IsHidden()return true end
function modifier_hd_potion_regen_mana_1:IsDebuff()return false end
function modifier_hd_potion_regen_mana_1:IsPurgable()return false end
function modifier_hd_potion_regen_mana_1:IsPurgeException() 	return false end
function modifier_hd_potion_regen_mana_1:RemoveOnDeath() return false end
function modifier_hd_potion_regen_mana_1:GetAttributes() return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE+ MODIFIER_ATTRIBUTE_MULTIPLE end
-- function modifier_hd_potion_regen_mana_1:GetTexture() return "modifier_illusion" end
function modifier_hd_potion_regen_mana_1:Precache( context )
	PrecacheResource( "particle", "particles/rebuild/potion/hd_potion_regen_mana/effect_use/effect.vpcf", context )

end
function modifier_hd_potion_regen_mana_1:OnCreated(keys)
    if IsServer() then
...
function modifier_hd_potion_regen_mana_1:PlayEffect(parent)
