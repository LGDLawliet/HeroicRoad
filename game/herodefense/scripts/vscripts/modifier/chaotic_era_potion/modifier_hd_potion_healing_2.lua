...
modifier_hd_potion_healing_2 = advanced_modifier({})

function modifier_hd_potion_healing_2:IsHidden()return true end
function modifier_hd_potion_healing_2:IsDebuff()return false end
function modifier_hd_potion_healing_2:IsPurgable()return false end
function modifier_hd_potion_healing_2:IsPurgeException() 	return false end
function modifier_hd_potion_healing_2:RemoveOnDeath() return false end
function modifier_hd_potion_healing_2:GetAttributes() return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE+ MODIFIER_ATTRIBUTE_MULTIPLE end
-- function modifier_hd_potion_healing_2:GetTexture() return "modifier_illusion" end
function modifier_hd_potion_healing_2:Precache( context )
	PrecacheResource( "particle", "particles/rebuild/potion/hd_potion_healing/effect_use/effect.vpcf", context )

end
function modifier_hd_potion_healing_2:OnCreated(keys)
    if IsServer() then
...
function modifier_hd_potion_healing_2:PlayEffect(parent)
