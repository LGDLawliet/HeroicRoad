...
Middle_Luminosity = class({})

LinkLuaModifier( "modifier_Middle_Luminosity", "skills/Middle_Luminosity", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_Middle_Luminosity_buff", "skills/Middle_Luminosity", LUA_MODIFIER_MOTION_NONE )

function Middle_Luminosity:GetIntrinsicModifierName()
	return "modifier_Middle_Luminosity"
end

--------------------------------------------------------------------------------
modifier_Middle_Luminosity = advanced_modifier({})

function modifier_Middle_Luminosity:IsHidden()
	return self:GetStackCount()<1
end
function modifier_Middle_Luminosity:IsDebuff()return false end
function modifier_Middle_Luminosity:IsPurgable()return false end

function modifier_Middle_Luminosity:OnCreated( kv )
...
function modifier_Middle_Luminosity:OnRefresh( kv )
	if not IsServer() then
		return 
	end
	self.parent = self:GetParent()
...
function modifier_Middle_Luminosity:ADDeclareFunctions()
    return 
    {
...
function modifier_Middle_Luminosity:Advanced_GetModifierCriticalStrike(keys)
	if IsServer() then
...
function modifier_Middle_Luminosity:OnAttackLanded(keys)
	if not IsServer() then
		return
	end
