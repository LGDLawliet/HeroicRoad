...
modifier_chaos_coming = advanced_modifier({})

function modifier_chaos_coming:IsHidden()return false end
function modifier_chaos_coming:IsDebuff()return false end
function modifier_chaos_coming:IsPurgable()return false end
function modifier_chaos_coming:IsPurgeException() 	return false end
function modifier_chaos_coming:RemoveOnDeath() return true end
function modifier_chaos_coming:GetAttributes() return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE end
function modifier_chaos_coming:GetTexture() return self.texture end

function modifier_chaos_coming:OnCreated(keys)
    if IsServer() then
        -- print("okkkkkkkkkkkk")
...
function modifier_chaos_coming:ModifyTaskData(data)
    -- print("处理符石")
