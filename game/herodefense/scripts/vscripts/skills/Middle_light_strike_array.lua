...
Middle_light_strike_array = class({})

LinkLuaModifier( "modifier_Middle_light_strike_array", "skills/Middle_light_strike_array", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_Middle_light_strike_array_2", "skills/Middle_light_strike_array", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Custom KV
-- AOE Radius
function Middle_light_strike_array:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end

--------------------------------------------------------------------------------
-- Ability Start
function Middle_light_strike_array:OnSpellStart()
	-- unit identifier
	...
	CreateModifierThinker(
		...
		self, -- ability source
		"modifier_Middle_light_strike_array", -- modifier name
...
function Middle_light_strike_array:Precache( context )
...
modifier_Middle_light_strike_array = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Middle_light_strike_array:IsHidden()	return true end
function modifier_Middle_light_strike_array:IsPurgable()	return false end


function modifier_Middle_light_strike_array:OnCreated( kv )
...
function modifier_Middle_light_strike_array:OnDestroy()
	if not IsServer() then return end
	-- destroy trees
	local ability = self:GetAbility()
	if not ability then
	...
	if #enemies>0 then
		CreateModifierThinker(
			...
			ability, -- ability source
			"modifier_Middle_light_strike_array_2", -- modifier name
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Middle_light_strike_array:PlayEffects1()
	-- Get Resources
...
function modifier_Middle_light_strike_array:PlayEffects2()
	-- Get Resources
...
modifier_Middle_light_strike_array_2 = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Middle_light_strike_array_2:IsHidden()	return true end
function modifier_Middle_light_strike_array_2:IsPurgable()	return false end


function modifier_Middle_light_strike_array_2:OnCreated( kv )
	if not IsServer() then return end
	local ability = self:GetAbility()

	self.damage = ability:GetSpecialValueFor( "damage" ) +  ability:GetSpecialValueFor( "bonus_damage" )*self:GetCaster():GetIntellect(false)
	self.damage = self.damage*math.min(kv.index*0.2,3)
	self.radius = ability:GetSpecialValueFor( "radius" )*2
	self:PlayEffects1()
end


function modifier_Middle_light_strike_array_2:OnDestroy()
	if not IsServer() then return end
	-- destroy trees
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Middle_light_strike_array_2:PlayEffects1()
	-- Get Resources
	local particle_cast = "particles/units/heroes/hero_lina/lina_spell_light_strike_array_ray_team.vpcf"
	local sound_cast = "Ability.PreLightStrikeArray"
...
function modifier_Middle_light_strike_array_2:PlayEffects2()
	-- Get Resources
