...
function Spawn( entityKeyValues )
	...
	Ability1 = thisEntity:FindAbilityByName( "creeps_spell_Summon_Tree_Spirit" )
...
function AIThink()
    ...
    if Ability1 ~= nil and Ability1:IsFullyCastable() then
		...
		DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES + DOTA_UNIT_TARGET_FLAG_NO_INVIS , FIND_FARTHEST, false )
