...
-- LinkLuaModifier("modifier_Middle_Spectral_Dagger_path", "skills/Middle_Spectral_Dagger", LUA_MODIFIER_MOTION_NONE)
-- LinkLuaModifier("modifier_Middle_Spectral_Dagger_in_path", "skills/Middle_Spectral_Dagger", LUA_MODIFIER_MOTION_NONE)
...
-- 	tHashtable.hAura = CreateModifierThinker(tHashtable.hCaster, self, "modifier_Middle_Spectral_Dagger_path", {hashtable_index = GetHashtableIndex(tHashtable)}, tHashtable.vStartPosition, tHashtable.hCaster:GetTeamNumber(), false)
...
-- 	end
-- end
-- function Middle_Spectral_Dagger:OnProjectileHit_ExtraData(hTarget, vLocation, ExtraData)
-- 	local tHashtable = GetHashtableByIndex(ExtraData.hashtable_index)

-- 	return false
-- end
-- function Middle_Spectral_Dagger:OnProjectileThink_ExtraData(vLocation, ExtraData)
-- 	local tHashtable = GetHashtableByIndex(ExtraData.hashtable_index)
...
-- 				hTarget:AddNewModifier(tHashtable.hCaster, self, "modifier_Middle_Spectral_Dagger", {duration=tHashtable.hero_path_duration, hashtable_index=ExtraData.hashtable_index})
-- 			end
...
-- 	end
-- end
-- function Middle_Spectral_Dagger:AddShadow(tHashtable, vLocation, duration)
...
-- 		tHashtable.timer_str = DoUniqueString("Middle_Spectral_Dagger")
...
-- 				tHashtable.hAura:FindModifierByName("modifier_Middle_Spectral_Dagger_path"):Destroy()
...
-- 	end
-- end
-- function Middle_Spectral_Dagger:IsHiddenWhenStolen()
-- 	return false
-- end
-- ---------------------------------------------------------------------
-- --Modifiers 给主目标添加的状态 移动时候会产生路径 虽然不是很需要 还是放着吧
-- if modifier_Middle_Spectral_Dagger == nil then
-- 	modifier_Middle_Spectral_Dagger = class({})
-- end
-- function modifier_Middle_Spectral_Dagger:IsHidden()return true end
-- function modifier_Middle_Spectral_Dagger:IsDebuff()return true end
...
-- function modifier_Middle_Spectral_Dagger:GetEffectName()return "particles/units/heroes/hero_spectre/spectre_shadow_path_owner.vpcf" end
-- function modifier_Middle_Spectral_Dagger:GetEffectAttachType()return PATTACH_ABSORIGIN_FOLLOW end
...
-- 	end
-- end
-- function modifier_Middle_Spectral_Dagger:CheckState()
-- 	return {
...
-- ---------------------------------------------------------------------
-- --路径的buff
-- if modifier_Middle_Spectral_Dagger_path == nil then
-- 	modifier_Middle_Spectral_Dagger_path = class({})
-- end
-- function modifier_Middle_Spectral_Dagger_path:IsHidden()return true end
-- function modifier_Middle_Spectral_Dagger_path:IsDebuff()return false end
-- function modifier_Middle_Spectral_Dagger_path:IsPurgable()return false end
-- function modifier_Middle_Spectral_Dagger_path:IsPurgeException()return false end
-- function modifier_Middle_Spectral_Dagger_path:IsStunDebuff()return false end
-- function modifier_Middle_Spectral_Dagger_path:AllowIllusionDuplicate()return false end
-- function modifier_Middle_Spectral_Dagger_path:GetAttributes()
-- 	return MODIFIER_ATTRIBUTE_MULTIPLE + MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
-- end
-- function modifier_Middle_Spectral_Dagger_path:IsAura()return true end
-- function modifier_Middle_Spectral_Dagger_path:GetAuraEntityReject(hEntity)
...
-- 				-- 	hEntity:AddNewModifier(self:GetCaster(), self:GetAbility(), "modifier_Middle_Spectral_Dagger_in_path", {duration=self.tHashtable.buff_persistence})
-- 				-- end
...
-- 				local modifier = hEntity:FindModifierByName("modifier_Middle_Spectral_Dagger_in_path")
-- 				if modifier then
-- 					modifier:SetDuration(self.tHashtable.buff_persistence,true)
-- 				else
-- 					hEntity:AddNewModifier(self:GetCaster(), ability, "modifier_Middle_Spectral_Dagger_in_path", {duration=self.tHashtable.buff_persistence})
-- 				end
-- 				return true
-- 			end
-- 		end
...
-- 	return true
-- end
-- function modifier_Middle_Spectral_Dagger_path:GetAuraDuration()return 1 end
-- function modifier_Middle_Spectral_Dagger_path:GetAuraRadius()return 3000 end
-- function modifier_Middle_Spectral_Dagger_path:GetAuraSearchTeam()return DOTA_UNIT_TARGET_TEAM_BOTH end
-- function modifier_Middle_Spectral_Dagger_path:GetAuraSearchType()return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
-- function modifier_Middle_Spectral_Dagger_path:GetAuraSearchFlags()return DOTA_UNIT_TARGET_FLAG_NONE end
-- function modifier_Middle_Spectral_Dagger_path:GetModifierAura()return "modifier_spectre_spectral_dagger_path" end
-- function modifier_Middle_Spectral_Dagger_path:OnCreated(params)
-- 	if IsServer() then
-- 		self.tHashtable = GetHashtableByIndex(params.hashtable_index)
-- 		-- self.buff_duration = self:GetAbility():GetSpecialValueFor("buff_persistence")
-- 	end
-- end
-- function modifier_Middle_Spectral_Dagger_path:OnDestroy()
-- 	if IsServer() then
-- 		self:GetParent():RemoveSelf()
-- 	end
-- end
-- ---------------------------------------------------------------------
-- if modifier_Middle_Spectral_Dagger_in_path == nil then
-- 	modifier_Middle_Spectral_Dagger_in_path = class({})
-- end
-- function modifier_Middle_Spectral_Dagger_in_path:IsHidden()return false end
-- function modifier_Middle_Spectral_Dagger_in_path:IsDebuff()return self:GetParent():GetTeamNumber() ~= self:GetCaster():GetTeamNumber() end
-- function modifier_Middle_Spectral_Dagger_in_path:IsPurgable()return false end
-- function modifier_Middle_Spectral_Dagger_in_path:IsPurgeException()return false end
-- function modifier_Middle_Spectral_Dagger_in_path:IsStunDebuff()return false end
-- function modifier_Middle_Spectral_Dagger_in_path:AllowIllusionDuplicate()return false end
-- function modifier_Middle_Spectral_Dagger_in_path:CheckState()
-- 	local state = {}
...
-- end
-- function modifier_Middle_Spectral_Dagger_in_path:GetAttributes()
-- 	return MODIFIER_ATTRIBUTE_IGNORE_INVULNERABLE
-- end
-- function modifier_Middle_Spectral_Dagger_in_path:OnCreated(table)
	
-- 	self.value = self:GetAbility():GetSpecialValueFor("bonus_movespeed") 
-- end
-- function modifier_Middle_Spectral_Dagger_in_path:DeclareFunctions()
-- 	return {
-- 		MODIFIER_PROPERTY_MOVESPEED_BONUS_CONSTANT,
-- 		MODIFIER_PROPERTY_ATTACKSPEED_BONUS_CONSTANT
-- 	}
-- end
-- function modifier_Middle_Spectral_Dagger_in_path:GetModifierMoveSpeedBonus_Constant(params)
...
-- function modifier_Middle_Spectral_Dagger_in_path:GetModifierAttackSpeedBonus_Constant()	
-- 	if self:GetParent()==self:GetCaster() then
-- 		return 100
-- 	end
-- 	return 0
