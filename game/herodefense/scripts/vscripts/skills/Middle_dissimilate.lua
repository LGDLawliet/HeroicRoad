Middle_dissimilate = class({})
LinkLuaModifier( "modifier_Middle_dissimilate", "skills/Middle_dissimilate", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Ability Start
function Middle_dissimilate:OnSpellStart()
	-- unit identifier
	...
	caster:AddNewModifier(
		...
		self, -- ability source
		"modifier_Middle_dissimilate", -- modifier name
...
function Middle_dissimilate:GetCooldown(iLevel)
	return self.BaseClass.GetCooldown(self,iLevel)/(math.max(self:GetCaster():GetCooldownReduction(),0.001))
end



modifier_Middle_dissimilate = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Middle_dissimilate:IsHidden()	return false end
function modifier_Middle_dissimilate:IsDebuff()	return false end
function modifier_Middle_dissimilate:IsPurgable()	return false end

function modifier_Middle_dissimilate:OnCreated( kv )
...
function modifier_Middle_dissimilate:OnRefresh( kv )
	
end

function modifier_Middle_dissimilate:OnRemoved()
end

function modifier_Middle_dissimilate:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_Middle_dissimilate:DeclareFunctions()
	local funcs = {
...
function modifier_Middle_dissimilate:OnOrder( params )
...
function modifier_Middle_dissimilate:GetModifierMoveSpeed_Limit()
	return 0.1
end

--------------------------------------------------------------------------------
-- Status Effects
function modifier_Middle_dissimilate:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Helper
function modifier_Middle_dissimilate:SetValidTarget( location )
	-- find max
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Middle_dissimilate:PlayEffects1( point, main )
	-- Get Resources
...
function modifier_Middle_dissimilate:ChangeEffects( old, new )
...
function modifier_Middle_dissimilate:PlayEffects2( point, hit )
	-- Get Resources
