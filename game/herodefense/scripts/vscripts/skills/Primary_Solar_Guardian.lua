...
--------------------------------------------------------------------------------
Primary_Solar_Guardian = class({})
LinkLuaModifier( "modifier_Primary_Solar_Guardian", "skills/Primary_Solar_Guardian", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_Primary_Solar_Guardian_leap", "skills/Primary_Solar_Guardian", LUA_MODIFIER_MOTION_NONE )


function Primary_Solar_Guardian:GetCastRange()
...
--------------------------------------------------------------------------------
-- Custom KV
function Primary_Solar_Guardian:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end

--------------------------------------------------------------------------------
-- Ability Start
function Primary_Solar_Guardian:OnSpellStart()
	-- unit identifier
	local caster = self:GetCaster()
	...
	caster:AddNewModifier(
		...
		self, -- ability source
		"modifier_Primary_Solar_Guardian", -- modifier name
		{
...
--------------------------------------------------------------------------------
-- Ability Channeling
function Primary_Solar_Guardian:OnChannelFinish( interrupted )
	-- unit identifier
	local caster = self:GetCaster()

	if interrupted then
		local mod = caster:FindModifierByName( "modifier_Primary_Solar_Guardian" )
	...
	caster:AddNewModifier(
		caster, -- player source
		self, -- ability source
		"modifier_Primary_Solar_Guardian_leap", -- modifier name
		{
			duration = duration,
			x = self.point.x,
			y = self.point.y,
...
function Primary_Solar_Guardian:Pulse(point, value_multiplier)	
...
modifier_Primary_Solar_Guardian = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Primary_Solar_Guardian:IsHidden()return false end
function modifier_Primary_Solar_Guardian:IsDebuff()return false end
function modifier_Primary_Solar_Guardian:IsPurgable()return false end

--------------------------------------------------------------------------------
-- Initializations
function modifier_Primary_Solar_Guardian:OnCreated( kv )
...
function modifier_Primary_Solar_Guardian:OnRefresh( kv )	
end

function modifier_Primary_Solar_Guardian:OnRemoved()
end

function modifier_Primary_Solar_Guardian:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_Primary_Solar_Guardian:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_Primary_Solar_Guardian:OnIntervalThink()
	-- find enemies
	local enemies = FindUnitsInRadius(
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Primary_Solar_Guardian:PlayEffects1()
	-- Get Resources
...
function modifier_Primary_Solar_Guardian:PlayEffects2( point, radius )
	-- Get Resources
...
function modifier_Primary_Solar_Guardian:PlayEffects3( point, radius )
	-- Get Resources
	local particle_cast = "particles/units/heroes/hero_dawnbreaker/dawnbreaker_solar_guardian_damage.vpcf"
...
function modifier_Primary_Solar_Guardian:PlayEffects4( target )
	-- Get Resources
...
--------------------------------------------------------------------------------
modifier_Primary_Solar_Guardian_leap = class({})


--------------------------------------------------------------------------------
-- Classifications
function modifier_Primary_Solar_Guardian_leap:IsHidden()return true end
function modifier_Primary_Solar_Guardian_leap:IsDebuff()return false end
function modifier_Primary_Solar_Guardian_leap:IsPurgable()return false end

function modifier_Primary_Solar_Guardian_leap:CheckState()
	local state =
	{
...
--------------------------------------------------------------------------------
-- Initializations
function modifier_Primary_Solar_Guardian_leap:OnCreated( kv )
...
function modifier_Primary_Solar_Guardian_leap:OnRefresh( kv )
end

function modifier_Primary_Solar_Guardian_leap:OnRemoved()
end

function modifier_Primary_Solar_Guardian_leap:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_Primary_Solar_Guardian_leap:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Graphics & Animations
-- function modifier_Primary_Solar_Guardian_leap:GetEffectName()
-- 	return "particles/units/heroes/hero_dawnbreaker/dawnbreaker_solar_guardian_airtime_buff.vpcf"
-- end

-- function modifier_Primary_Solar_Guardian_leap:GetEffectAttachType()
-- 	return PATTACH_ABSORIGIN_FOLLOW
-- end

function modifier_Primary_Solar_Guardian_leap:PlayEffects1()
	-- Get Resources
...
function modifier_Primary_Solar_Guardian_leap:PlayEffects2( point, radius )
	-- Get Resources
