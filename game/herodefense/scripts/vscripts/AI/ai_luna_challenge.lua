...
function Spawn( entityKeyValues )
	...
	Ability1 = thisEntity:FindAbilityByName( "luna_challenge_Lucent_Beam" )
	...
	Timers:CreateTimer(0.05, function()
		if thisEntity.challenge_level then
			...
			unit:SetBaseDamageMax(80+7*_G.GAME_ROUND*level)
			unit:SetBaseDamageMin(80+7*_G.GAME_ROUND*level)
		...
		elseif thisEntity.endlessLevel then
			...
			local unit = thisEntity
			unit:SetBaseDamageMax(2500+1700*level*(1+level*0.04))
			unit:SetBaseDamageMin(2500+1700*level*(1+level*0.04))
