...
LinkLuaModifier( "modifier_Middle_Unstable_Concoction", "skills/Middle_Unstable_Concoction", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_Middle_Unstable_Concoction_u235", "skills/Middle_Unstable_Concoction", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier( "modifier_generic_stunned_long", "modifier/generic/modifier_generic_stunned_long", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- MAIN
--------------------------------------------------------------------------------
Middle_Unstable_Concoction = class({})

--------------------------------------------------------------------------------
-- Ability Start
function Middle_Unstable_Concoction:OnSpellStart()
	-- unit identifier
	...
	caster:AddNewModifier(
		...
		self, -- ability source
		"modifier_Middle_Unstable_Concoction", -- modifier name
		{ duration = duration } -- kv
	)

	-- check sister ability
	local ability = caster:FindAbilityByName( "Middle_Unstable_Concoction_Throw" )
	if not ability then
		ability = caster:AddAbility( "Middle_Unstable_Concoction_Throw" )
...
-- THROW
--------------------------------------------------------------------------------
Middle_Unstable_Concoction_Throw = class({})

--------------------------------------------------------------------------------
-- Custom KV
function Middle_Unstable_Concoction_Throw:GetAOERadius()
	return self:GetSpecialValueFor( "midair_explosion_radius" )
end

--------------------------------------------------------------------------------
-- Ability Event
function Middle_Unstable_Concoction_Throw:OnUpgrade()
	-- if somehow a player got cornered enough to level up Concoction during throw, sync level
	local ability = self:GetCaster():FindAbilityByName( "Middle_Unstable_Concoction" )
	ability:SetLevel( self:GetLevel() )
end
...
--------------------------------------------------------------------------------
-- Ability Start
function Middle_Unstable_Concoction_Throw:OnSpellStart()
	-- unit identifier
	local caster = self:GetCaster()
	...
	local modifier = caster:FindModifierByName( "modifier_Middle_Unstable_Concoction" )
	if modifier then
		 -- cast by sister ability
		brew_time = math.min( GameRules:GetGameTime()-modifier:GetCreationTime(), max_brew )
		modifier:SafeDestroy()

	elseif Middle_Unstable_Concoction_Throw.reflected_brew_time then
		-- reflected
		brew_time = Middle_Unstable_Concoction_Throw.reflected_brew_time
	...
	-- switch ability layout
	local ability = caster:FindAbilityByName( "Middle_Unstable_Concoction" )
...
--------------------------------------------------------------------------------
-- Projectile
function Middle_Unstable_Concoction_Throw:OnProjectileHit_ExtraData( target, location, ExtraData )
	...
	Middle_Unstable_Concoction_Throw.reflected_brew_time = brew_time
	...
	Middle_Unstable_Concoction_Throw.reflected_brew_time = nil
	...
	target:AddNewModifier(
		...
		self, -- ability source
		"modifier_Middle_Unstable_Concoction_u235", -- modifier name
		{ duration = stun*2*StatusResistance ,gain = gain} -- kv
	)
...
------------------------------------------------------------------------------
function Middle_Unstable_Concoction_Throw:PlayEffects( target )
	-- Get Resources
...
--------------------------------------------------------------------------------
modifier_Middle_Unstable_Concoction = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_Middle_Unstable_Concoction:IsHidden()
	return true
end

function modifier_Middle_Unstable_Concoction:IsDebuff()
	return false
end

function modifier_Middle_Unstable_Concoction:IsStunDebuff()
	return false
end

function modifier_Middle_Unstable_Concoction:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_Middle_Unstable_Concoction:OnCreated( kv )
	-- references
...
function modifier_Middle_Unstable_Concoction:OnRefresh( kv )
	
end

function modifier_Middle_Unstable_Concoction:OnRemoved()
end

function modifier_Middle_Unstable_Concoction:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_Middle_Unstable_Concoction:OnIntervalThink()
	-- tick
	...
	-- switch ability layout
	local ability = self:GetCaster():FindAbilityByName( "Middle_Unstable_Concoction_Throw" )
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_Middle_Unstable_Concoction:PlayEffects1( target )
	-- Get Resources
	local particle_cast = "particles/units/heroes/hero_alchemist/alchemist_unstable_concoction_explosion.vpcf"
	local sound_cast = "Hero_Alchemist.UnstableConcoction.Stun"
...
function modifier_Middle_Unstable_Concoction:PlayEffects2()
	-- Get Resources
...
modifier_Middle_Unstable_Concoction_u235		= class({})

function modifier_Middle_Unstable_Concoction_u235:IsHidden()		return false end
function modifier_Middle_Unstable_Concoction_u235:IsPurgable()		return false  end
function modifier_Middle_Unstable_Concoction_u235:IsPurgeException()		return true  end
function modifier_Middle_Unstable_Concoction_u235:RemoveOnDeath()	return false end

function modifier_Middle_Unstable_Concoction_u235:OnCreated(keys)
...
function modifier_Middle_Unstable_Concoction_u235:OnIntervalThink()
	if IsClient() then
		return
	end
...
function modifier_Middle_Unstable_Concoction_u235:PlayEffects2( target )
	-- Get Resources
