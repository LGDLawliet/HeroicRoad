...
-- LinkLuaModifier( "modifier_Primary_summon_earth_element_debuff", "skills/Primary_summon_earth_element", LUA_MODIFIER_MOTION_NONE )
Primary_summon_earth_element						= Primary_summon_earth_element or class({})
require("internal/timers")


function Primary_summon_earth_element:IsSummonSpell()return true end
function Primary_summon_earth_element:IsElementSummon()return true end



function Primary_summon_earth_element:OnSpellStart()
	...
	Timers(1.2, function()
		...
		-- Timers(1.2, function()
		-- 	print("ok")
		-- 	unit:SetOriginalModel("models/monster/golem/rock_golem.vmdl")
		-- end)
	...
	-- caster:AddNewModifier(caster, self, "modifier_Primary_summon_earth_element_debuff", 
