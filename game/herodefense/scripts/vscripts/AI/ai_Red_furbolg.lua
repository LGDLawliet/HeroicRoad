...
function Spawn( entityKeyValues )
	...
	Ability1 = thisEntity:FindAbilityByName( "creeps_spell_Fury_Strike" )
	...
	-- thisEntity:SetSkin(RandomInt(0, 3))
end
...
function CallousFurbolgThink()
    ...
    if Ability1 ~= nil and Ability1:IsFullyCastable() then
		local enemies = FindUnitsInRadius( thisEntity:GetTeamNumber(), thisEntity:GetOrigin(), nil, 200, 
	...
	return 0.5+RandomFloat(0.0,0.7)
end
