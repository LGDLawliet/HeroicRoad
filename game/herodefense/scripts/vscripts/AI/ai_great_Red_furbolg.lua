...
function Spawn( entityKeyValues )
	...
	Ability1 = thisEntity:FindAbilityByName( "creeps_spell_Great_Fury_Strike" )
	-- ultAbility = thisEntity:FindAbilityByName( "culling_blade_datadriven" )
	thisEntity:SetContextThink( "CallousFurbolgThink", CallousFurbolgThink, 0.5 )
...
function CallousFurbolgThink()
	...
	return 0.5+RandomFloat(0.0,0.4)
end
