modifier_imgeneric_knockback_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_imgeneric_knockback_lua:IsHidden()
	return true
end

function modifier_imgeneric_knockback_lua:IsPurgable()
	return false
end

function modifier_imgeneric_knockback_lua:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_imgeneric_knockback_lua:OnCreated( kv )
	if IsServer() then
...
function modifier_imgeneric_knockback_lua:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_imgeneric_knockback_lua:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function modifier_imgeneric_knockback_lua:SetEndCallback( func )
	self.EndCallback = func
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_imgeneric_knockback_lua:DeclareFunctions()
	local funcs = {
...
function modifier_imgeneric_knockback_lua:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_imgeneric_knockback_lua:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_imgeneric_knockback_lua:UpdateHorizontalMotion( me, dt )
...
function modifier_imgeneric_knockback_lua:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_imgeneric_knockback_lua:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_imgeneric_knockback_lua:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:SafeDestroy()
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_imgeneric_knockback_lua:GetEffectName()
	if not IsServer() then return end
	if self.stun then
...
function modifier_imgeneric_knockback_lua:GetEffectAttachType()
	if not IsServer() then return end
