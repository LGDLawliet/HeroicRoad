...
function Spawn( entityKeyValues )
	...
	thisEntity.hArrowAbility = thisEntity:FindAbilityByName( "creeps_spell_Luna_Arrow" )
...
function AIThink()
	...
	local hEnemies = FindUnitsInRadius( thisEntity:GetTeamNumber(), thisEntity:GetOrigin(), nil, 2000,
