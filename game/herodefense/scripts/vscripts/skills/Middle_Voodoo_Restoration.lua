...
Middle_Voodoo_Restoration = class({})
LinkLuaModifier("modifier_Middle_Voodoo_Restoration", "skills/Middle_Voodoo_Restoration", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_Middle_Voodoo_Restoration_heal", "skills/Middle_Voodoo_Restoration", LUA_MODIFIER_MOTION_NONE)




function Middle_Voodoo_Restoration:GetCastRange()
	return self:GetSpecialValueFor("radius")
end

function Middle_Voodoo_Restoration:Spawn()
	if IsServer() then
		self.healingStack = 0
	end
end
function Middle_Voodoo_Restoration:StackHealing(stack)
	self.healingStack = self.healingStack + stack
end

function Middle_Voodoo_Restoration:GetHealingStackAndRefresh()
...
function Middle_Voodoo_Restoration:OnToggle()
	if self:GetToggleState() then
		...
		self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_Middle_Voodoo_Restoration", {})
		...
		self:GetCaster():RemoveModifierByName("modifier_Middle_Voodoo_Restoration")
	end
end

modifier_Middle_Voodoo_Restoration = modifier_Middle_Voodoo_Restoration or class({})
function modifier_Middle_Voodoo_Restoration:IsDebuff() return false end
function modifier_Middle_Voodoo_Restoration:IsHidden() return true end
function modifier_Middle_Voodoo_Restoration:IsPurgable() return false end
function modifier_Middle_Voodoo_Restoration:IsPurgeException() return false end
function modifier_Middle_Voodoo_Restoration:IsAura()	return true end
function modifier_Middle_Voodoo_Restoration:IsAuraActiveOnDeath()	return false end
function modifier_Middle_Voodoo_Restoration:GetAuraRadius()	return self.radius end
function modifier_Middle_Voodoo_Restoration:GetAuraSearchTeam()	return DOTA_UNIT_TARGET_TEAM_FRIENDLY end
function modifier_Middle_Voodoo_Restoration:GetAuraSearchType()	return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end
function modifier_Middle_Voodoo_Restoration:GetModifierAura()	return "modifier_Middle_Voodoo_Restoration_heal" end
function modifier_Middle_Voodoo_Restoration:OnCreated()
...
function modifier_Middle_Voodoo_Restoration:OnDestroy()
	if IsServer() then
...
function modifier_Middle_Voodoo_Restoration:OnIntervalThink()
	...
	if caster:GetMana() >= hAbility:GetManaCost(-1) then
		...
		local heal	= (hAbility:GetSpecialValueFor("basic_heal")+hAbility:GetSpecialValueFor("bonus_heal")*caster:GetIntellect(false))*0.5
...
function modifier_Middle_Voodoo_Restoration:PlayEffect(target)
	-- local caster = self:GetCaster()
...
-------------------------------------------
modifier_Middle_Voodoo_Restoration_heal = class({})
function modifier_Middle_Voodoo_Restoration_heal:IsDebuff() return false end
function modifier_Middle_Voodoo_Restoration_heal:IsHidden() return true end
function modifier_Middle_Voodoo_Restoration_heal:IsPurgable() return false end
function modifier_Middle_Voodoo_Restoration_heal:IsPurgeException() return false end
function modifier_Middle_Voodoo_Restoration_heal:IsStunDebuff() return false end
function modifier_Middle_Voodoo_Restoration_heal:RemoveOnDeath() return true end


-- function modifier_Middle_Voodoo_Restoration_heal:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end -- Why was this made to stack
-------------------------------------------
function modifier_Middle_Voodoo_Restoration_heal:OnCreated()
	if not self:GetAbility() or self:GetAbility():IsNull() then self:SafeDestroy() return end
	if IsServer() then
		self.interval = 1
		self:StartIntervalThink( self.interval )
...
function modifier_Middle_Voodoo_Restoration_heal:OnIntervalThink()
	if not self:GetAbility() or self:GetAbility():IsNull() then self:SafeDestroy() return end
