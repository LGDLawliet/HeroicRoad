Primary_quadruple_chop = class({})

-- LinkLuaModifier( "modifier_Primary_quadruple_chop", "skills/Primary_quadruple_chop", LUA_MODIFIER_MOTION_NONE )

require('internal/timers')   --计时器功能


function Primary_quadruple_chop:OnSpellStart()
...
--------------------------------------------------------------------------------
function Primary_quadruple_chop:PlayEffects1( origin, target )
...
-- function Primary_quadruple_chop:PlayEffects2( target )
